...
export const EXPERIENCES: readonly Experience[] = [
  {
    ...
    techStack: [
      { name: 'React', role: 'Primary frontend framework for enterprise UI modernization' },
      { name: 'TypeScript', role: 'Static typing across frontend codebases' },
      { name: 'Java', role: 'Scalable backend services and API development' },
      { name: 'Spring Boot', role: 'Layered backend architecture (controller / service / repository)' },
      { name: 'Express', role: 'Node.js REST API for AI-assisted full-stack workflow services' },
      { name: 'jQuery', role: 'Legacy frontend maintained during phased React migration' },
      { name: 'Marketo', role: 'End-to-end analytics and automated email campaign tracking' },
    ],
  },
  {
    company: 'Gaine',
    ...
    techStack: [
      { name: 'Neo4j', role: 'Graph database for provider network modeling and analysis' },
      { name: 'Cypher', role: 'Query language for graph data migration and optimization' },
    ],
  },
  {
    company: 'Mindbody',
    ...
    techStack: [
      { name: 'Java', role: 'Primary language for Android feature development' },
      { name: 'Android SDK', role: 'Core framework for native Android UI and lifecycle management' },
      { name: 'ViewGroup & Adapters', role: 'Efficient list rendering and data binding for dashboard components' },
      { name: 'ViewHolder & LayoutManager', role: 'View recycling patterns and layout configuration for list UIs' },
      { name: 'Fragments & Activities', role: 'Screen composition and lifecycle-aware UI management' },
      { name: 'Android Studio', role: 'IDE for development, debugging, and emulation' },
