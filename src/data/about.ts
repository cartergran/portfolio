...
export const ABOUT_CONTENT: AboutContent = {
  ...
  paragraphs: [
    ...
    "I came into Cornell as an undeclared engineering student and didn't take my first computer science course until the spring of freshman year. Starting behind pushed me to develop a disciplined approach to learning and problem solving. By junior year, I had affiliated with computer science and went on to graduate on time, including a semester abroad.",
    "After graduating, I went into consulting to broaden my exposure across different fields of software development. Working on a range of projects helped me understand not just how to build systems, but how different technical decisions impact real users and business outcomes. Through that experience, I found a strong pull toward web development, where the challenge of building robust systems is matched by the satisfaction of seeing them solve real problems.",
